...
// Ограничить количество повторений чисел вторым параметром в методе

public class StreamRepeatedNumbersInArray {
    ...
    static int[] arrInt(int[] array, int num) {
        ...
        return Arrays.stream(array) // Преобразуем массив в поток IntStream
                ...
                .mapToInt(value -> value) // Преобразуем Stream<Integer> обратно в IntStream
